...
const LoginPage = () => {
  ...
  const setCookie = () => {
    ...
    const accessToken =
      "eyJhbGciOiJIUzM4NCJ9.eyJzdWIiOiJjYjg5OWJjOC0zM2E5LTQzYTYtOTM4Yy03NmIwZWMyODZjNzciLCJleHAiOjE2OTk5NTc4NDEsImlzcyI6IlR1bmVtYXRlIn0.O93ytWAsJsQrzccfADjw1wSeMD_oGLEvhEatLLlXMsdHq6uTmu4G9niCZWW0jHxL";
    const refreshToken =
      "eyJhbGciOiJIUzM4NCJ9.eyJzdWIiOiJSZWZyZXNoIFRva2VuIiwidXNlcklkIjoiY2I4OTliYzgtMzNhOS00M2E2LTkzOGMtNzZiMGVjMjg2Yzc3IiwiZXhwIjoxNzAxMTYwMjQxLCJpc3MiOiJUdW5lbWF0ZSJ9.MOa8bohK_GBRRcJJhqBfqQ7j9V-drdt84raWXjsjp1WfznBLCt5hvylp3wEnA4bB";
