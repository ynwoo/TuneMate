...
const LoginPage = () => {
  ...
  const setCookie = () => {
    ...
    const accessToken =
      "eyJhbGciOiJIUzM4NCJ9.eyJzdWIiOiJhYjFiNGI3Zi1hYmIyLTRiZjEtOTIwZi1iNDM3MjMzYjRmNDciLCJleHAiOjE3MDAwMzcxNTMsImlzcyI6IlR1bmVtYXRlIn0.JzzdmRmT6EEtPR-2OTfldZsj4RQFIWkRYFatlFzl8Ir8ky-OuDu40kgNcrR4K0O5";
    const refreshToken =
      "eyJhbGciOiJIUzM4NCJ9.eyJzdWIiOiJhYjFiNGI3Zi1hYmIyLTRiZjEtOTIwZi1iNDM3MjMzYjRmNDciLCJleHAiOjE3MDAwMzcxNTMsImlzcyI6IlR1bmVtYXRlIn0.JzzdmRmT6EEtPR-2OTfldZsj4RQFIWkRYFatlFzl8Ir8ky-OuDu40kgNcrR4K0O5";
