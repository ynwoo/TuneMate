...
class GroupParticipationRequestServiceImplTest {
    ...
    @Autowired
    GroupParticipationRequestRepository groupParticipationRequestRepository;
    @Autowired
    ...
    @DisplayName("getReferenceByGroupId로 저장")
    @Transactional
    @Test
    void getReference() {
        // given
        ...
        // when
        Group groupReference = groupRepository.getReferenceByGroupId(groupId);
        ...
        // then
        Assertions.assertThatNoException().isThrownBy(() -> groupParticipationRequestRepository.save(groupParticipationRequest));
    }
}